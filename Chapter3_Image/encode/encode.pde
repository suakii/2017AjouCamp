...
void setup() {
  cover = loadImage("ajou.jpg");   // Load the cover picture
  secret = loadImage("gshs.jpg");   // Load the image to encode into the cover
  size(577, 577);  // Size the sketch to be the same size as the cover
  image(cover, 0, 0);
} // end setup()
